...
def create_mb_tiny_fd(num_classes, is_test=False, device="cpu"):
    """Create an SSD model using Mb_Tiny as the base network."""
    base_net = Mb_Tiny(2)  # Initialize the base network
